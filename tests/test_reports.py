...
def test_get_date_optional():
    mock_get_date_optional = Mock(
        return_value=("2021-07-14 15:30:00", "2021-03-14 15:30:00")
    )
...
def test_spending_by_category():
    mock_spending_by_category = Mock(
        return_value=[{'Yes': [50, 21], 'No': [131, 2]}]
    )
...
def test_get_path_1(mock_get_path):
    ...
    assert get_path("../data/operation_test.xlsx") == {'Валюта операции': 'RUB', 'Номер карты': '*7197', 'Статус': 'OK'}
